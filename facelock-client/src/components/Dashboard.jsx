    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-2 text-xl font-bold text-gray-900">FaceLock</span>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Welcome to your secure FaceLock dashboard</p>
        </div>
            ...
            <div className="flex items-center">
              <div className="p-2 bg-purple-100 rounded-lg">
                <svg className="h-6 w-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3a4 4 0 118 0v4m-4 10V9m-2 8h4a2 2 0 002-2V9a2 2 0 00-2-2H8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                </svg>
              </div>
              <div className="ml-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center p-3 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-900">Successful login with face recognition</p>
            ...
            <div className="flex items-center p-3 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-900">Account verified successfully</p>
                <p className="text-xs text-gray-500">Earlier today</p>
              </div>
            </div>
          </div>
        </div>
